...
const projectProfile = {
  ...
  "name": "BugHunter",
  "slug": "bughunter",
  "tagline": "Triagem inteligente de bugs com SLA e contexto tecnico.",
  "vertical": "quality-ops",
  "entity": {
    "singular": "bug",
    "plural": "bugs"
  },
  "copy": {
    "titleLabel": "Titulo do bug",
    "detailsLabel": "Passos para reproduzir",
    "createButton": "Registrar bug",
    "workspaceTitle": "Fila de bugs e correcao",
    "workspaceDescription": "Organize triagem com prioridades reais para reduzir tempo de resposta."
  },
  "mvp": [
    "Cadastro de bug com impacto, prioridade e contexto tecnico.",
    "Fila operacional com filtros por status e prioridade.",
    "Atualizacao rapida para reabrir ou concluir incidentes.",
    "Visao de backlog com indicadores de produtividade."
  ],
  "workflow": [
    "Receber bug e registrar contexto minimo obrigatorio.",
    "Classificar impacto e definir prioridade da correcao.",
    "Executar ajuste, validar e marcar como concluido."
  ],
  "seedItems": [
    {
      "title": "Erro 500 ao salvar perfil",
      "details": "Reproduzir no fluxo de atualizar avatar com arquivo acima de 2 MB.",
      "priority": "high",
      "status": "open"
    },
    {
      "title": "Tooltip bloqueando clique no CTA",
      "details": "No mobile o tooltip do plano premium cobre o botao de assinar.",
      "priority": "medium",
      "status": "open"
    },
    {
      "title": "Ajuste no texto de erro de login",
      "details": "Mensagem antiga ainda aparece apos resposta 401 no endpoint de sessao.",
      "priority": "low",
      "status": "done"
    }
  ]
