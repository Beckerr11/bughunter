...
const mvp = [
  "Cadastro padronizado com templates por categoria.",
  "Prioridade sugerida por impacto e urgencia.",
  "Deteccao de potenciais duplicidades.",
  "Acompanhamento de SLA por responsavel."
];
const hero = "https://picsum.photos/seed/bughunter-hero/1920/1080";
  ...
  return (
    <div className="page">
      <header className="hero full-bleed" style={{ "--hero": `url(${hero})` } as CSSProperties}>
        <nav className="nav"><p className="brand">BugHunter</p><a className="btn btn-ghost" href="#mvp">MVP</a></nav>
        <div className="hero-content">
          <p className="eyebrow">quality</p>
          <h1>Triagem inteligente de bugs para times de produto.</h1>
          <p className="lead">Bugs chegam com contexto fraco, duplicidade e prioridade incerta.</p>
      ...
      <main className="shell">
        ...
        <section className="section split" data-reveal>
          ...
          <article><p className="label">Produto</p><h2>Licenca por workspace com pacote por volume.</h2><p className="lead" style={{ color: "var(--muted)" }}>Base pronta para evoluir com autenticacao, banco e analytics.</p></article>
        </section>
      ...
      <footer className="footer"><p>BugHunter</p><p>{new Date().getFullYear()} - Projeto com padrao senior.</p></footer>
    </div>
  );
}
